...
namespace ProjectMVC.Controllers
{
    public class HeThongPhanPhoiController : Controller
    {
        ...
        // GET: HeThongPhanPhoi
        public async Task<IActionResult> Index()// phương thức Index để hiển thị danh sách HeThongPhanPhoi
        {
            return View(await _context.HeThongPhanPhoi.ToListAsync());// trả về view với danh sách HeThongPhanPhoi từ database
        }
